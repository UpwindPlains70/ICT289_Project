...
float speedMod = 500; /// control the speed of all the movements
...
Point3D startingPos[2] = { {70.0, 0.0, -10.0}, {70.0, 0.0, -55.0}  };   // 77.0, 0, -15.0); /// starting location of player1  // (77.0, 0 , -50.0); /// starting location of player2
Point3D rackPos[2];
    ///Swing animation parameters
#define TIMERMSECS 150 /// callback frequency
int maxSwingAngle = 60; ///Max swing angle of players

float maxSwingSpeed = 90; ///Allows for adjustable game parameters
float minSwingSpeed = 60;
float defaultSwingSpeed = 70;
